Public Class frmTest
    ...
    Private Sub btnGetRegions_Click(sender As System.Object, e As System.EventArgs) Handles btnGetRegions.Click
    ...
    Private Sub btnGetBorders_Click(sender As System.Object, e As System.EventArgs) Handles btnGetBorders.Click
    ...
    Private Sub lstBorder_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles lstBorder.SelectedIndexChanged
        ...
        Borders.Item(k).Draw(picCanvas.Image, Color.Yellow)
        picCanvas.Refresh()
        txtBorder.Text = Borders.Item(k).ToString
    End Sub
End Class
