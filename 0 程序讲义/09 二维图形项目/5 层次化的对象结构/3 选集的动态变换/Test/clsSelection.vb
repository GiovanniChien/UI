...
Public Class clsSelection
    ...
    Public Function Clone() As clsSelection
        Dim Selection As New clsSelection
        For i = 0 To Elems.Count - 1
            Selection.Append(Elems.Item(i).Clone)
        Next
        Return Selection
    End Function

    Public Sub Draw(ByVal g As Graphics, ByVal m As clsMatrix3, ByVal State As ObjectState)
        For i = 0 To Elems.Count - 1
