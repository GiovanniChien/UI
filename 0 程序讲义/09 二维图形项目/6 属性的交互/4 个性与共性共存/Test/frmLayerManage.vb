Public Class frmLayerManage
    ...
    Private Sub lstLayer_MouseDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles lstLayer.MouseDoubleClick
        Dim k As Integer = lstLayer.SelectedIndex
        layers.SetShow(k)
        lstLayer.Items(k) = layers.Item(k).ToString
    End Sub

    Private Sub lstLayer_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstLayer.SelectedIndexChanged
