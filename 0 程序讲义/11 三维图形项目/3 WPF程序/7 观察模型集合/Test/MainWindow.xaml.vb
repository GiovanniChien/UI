...
Imports System.Math
Class MainWindow
    Dim Models As clsModels
    Dim Camera1, Camera2 As clsCamera
    Dim lastp1, lastp2 As Point
    Private Sub MainWindow_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        Models = New clsModels
        Camera1 = New clsCamera(myCamera1, New Point3D(0, 0, 0), 200, 20, 50)
        Camera2 = New clsCamera(myCamera2, New Point3D(0, 0, 0), 300, 30, 60)
    End Sub

    Private Sub btn1_Click(sender As Object, e As RoutedEventArgs) Handles btn1.Click
        Dim m1 As New clsModel("Twoman1.stl")
        Dim m2 As New clsModel("Twoman2.stl")
        Models.Append(m1)
        Models.Append(m2)
