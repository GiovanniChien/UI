...
Public Class FrmTest
    ...
    Private Sub FrmTest_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ViewBoxs(0) = New clsViewBox(rtLeftUp, Model.box)  '左上
        ViewBoxs(1) = New clsViewBox(rtLeftDown, Model.box) '左下
        ViewBoxs(2) = New clsViewBox(rtRightUp, Model.box) '右上
        ViewBoxs(3) = New clsViewBox(rtRightDown, Model.box) '右下
    End Sub
