...
Public Class FrmTest
    ...
    Private Sub btnPan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLeft.Click, btnRight.Click, btnTop.Click, btnBottom.Click
        If sender Is btnLeft Then ViewBox.Pan(-2, 0)
        If sender Is btnRight Then ViewBox.Pan(2, 0)
        If sender Is btnTop Then ViewBox.Pan(0, 2)
        If sender Is btnBottom Then ViewBox.Pan(0, -2)
        Draw()
    End Sub
