Public Class clsBox
    ...
    End Sub
    Public Sub Contain(x As Single, y As Single, z As Single)
    ...
    Private Sub Zoom(ByRef Rect As RectangleF, scale As Double)
        Rect.X -= Rect.Width * (scale - 1) / 2 : Rect.Width = Rect.Width * scale
        Rect.Y -= Rect.Height * (scale - 1) / 2 : Rect.Height = Rect.Height * scale
    End Sub
